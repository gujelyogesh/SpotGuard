...
const Home = () => {
    return (
        <>
            ...
            <div className="container">
                ...
                <div className="section pt-3">
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            <h2 className="mt-5 display-6 pb-4 text-center">About SpotGuard.AE</h2>
            ...
            {/* carouselSlider end */}
            {/*Why Choose SpotGuard start  */}
            <div className="container">
                <div className="pt-4">
                    <h1 className="fw-bold pb-4">Why Choose SpotGuard for Residential Cleaning in Dubai?</h1>
                </div>
                <div className="d-flex py-2">
                    <span> <IoIosArrowForward className="mt-1 mr-2 fw-bold" /></span>
                    <p className="">Expert Team:Our cleaners are highly trained, experienced, and dedicated to delivering exceptional results.</p>
                </div>
                <div className="d-flex py-2">
                    <spn><IoIosArrowForward className="mr-2 mt-1 fw-bold" /></spn>
                ...
                <div className="d-flex py-2">
                    <span>
                        <IoIosArrowForward className="mr-2 mt-1 fw-bold" />
                    </span>
                    <p className=""> Flexible Scheduling: We offer convenient scheduling options to fit your busy lifestyle.</p>
                </div>
                <div className="d-flex py-2">
                    <span><IoIosArrowForward className="mr-2 mt-1 fw-bold" /></span>
