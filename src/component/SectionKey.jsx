    ...
    return (
        <>
            <section className="pt-2">
                <h1 className="text-center pt-4 fw-bold display-4">Key Areas of Expertise</h1>
                <div className="row pt-3">
                    <div className="col-md-4">
                        <div className="d-flex justify-content-center align-items-center">
                            <IoHomeOutline className="display-6" style={{ color: "#fff", backgroundColor: "#FAD02C" }} />
                        </div>
                        <div className="d-flex justify-center align-items-center pt-2">
                            <a href className="mb-1 display-6 fw-bold hover">Residential</a>
                        </div>
                    ...
                    <div className="col-md-4">
                        <div className="d-flex justify-content-center align-items-center ">
                            <MdOutlineDoorFront className="display-6" style={{ color: "#fff", backgroundColor: "#FAD02C" }} />
                        </div>
                        <div className="d-flex justify-center align-items-center pt-2">
                            <a href className="mb-1 display-6 fw-bold hover">Commercial</a>
                        </div>
                    ...
                    <div className="col-md-4">
                        <div className="d-flex justify-content-center align-items-center">
                            <FaHandsBubbles className="display-6" style={{ color: "#fff", backgroundColor: "#FAD02C" }} />
                        </div>
                        <div className="d-flex justify-center align-items-center pt-2">
                            <a href className="mb-1 display-6 fw-bold hover">Specialised</a>
                        </div>
