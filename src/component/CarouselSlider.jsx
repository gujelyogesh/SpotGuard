...
<div className="row pb-4 pt-4">
  ...
  <div className="carousel-inner">
    <div className="carousel-item active pb-5">
        <div className="mb-3">
        <h2 className="text-white text-center display-6 pb-3"> Reliable Cleaning </h2>
        </div>
    ...
    <div className="carousel-item pb-5">
        <div className="mb-3">
    <h2 className="text-white text-center display-6 pb-3">Outstanding Retail Cleaning</h2> 
        </div>
    ...
    <div className="carousel-item pb-5">
        <div className="mb-3">
    <h2 className="text-white text-center display-6 pb-2"> Spotless Home and Eco-Friendly Products </h2>
        </div>
    ...
    <div className="carousel-item pb-5">
        <div className="mb-3">
    <h2 className="text-white text-center pb-3 display-6"> Top-notch Cleaning Service in Abu Dhabi </h2>
        </div>
    ...
    <div className="carousel-item pb-5">
        <div className="mb-3">
    <h2 className="text-white text-center display-6 pb-2"> A Lifesaver for Busy Families in Sharjah </h2>
        </div>
    ...
    <div className="carousel-item pb-5">
        <div className="mb-3">
    <h2 className="text-white text-center display-6 pb-2"> Exceptional Office Cleaning in Dubai </h2>
        </div>
